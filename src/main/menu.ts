    ...
    buildDarwinTemplate({
        ...
        const subMenuHelp: MenuItemConstructorOptions = {
            ...
            submenu: [
                {
                    click() {
                        shell.openExternal('https://github.com/kevlaws/feishin');
                    },
                    label: 'Learn More',
                },
                {
                    click() {
                        shell.openExternal(
                            'https://github.com/kevlaws/feishin?tab=readme-ov-file#getting-started',
                        );
                    },
                    label: 'Documentation',
                },
                {
                    click() {
                        shell.openExternal('https://github.com/kevlaws/feishin/discussions');
                    },
                    label: 'Community Discussions',
                },
                {
                    click() {
                        shell.openExternal('https://github.com/kevlaws/feishin/issues');
                    },
                    label: 'Search Issues',
                },
                { type: 'separator' },
