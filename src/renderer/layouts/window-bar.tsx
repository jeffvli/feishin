...
export const WindowBar = () => {
    ...
    const title = useMemo(() => {
        ...
        if (isRadioActive) {
            ...
            return `${radioStatusString}${radioTitle}${radioMetadata} — XMS${privateMode ? ` ${privateModeString}` : ''}`;
        }
        ...
        const title = `${
            queueLength
                ? `${statusString}${queueString}${currentSong?.name}${currentSong?.artistName ? ` — ${currentSong?.artistName} — XMS` : ''}`
                : 'XMS'
