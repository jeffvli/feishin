...
import { usePlayerMuted, usePlayerVolume } from '/@/renderer/store/player.store';
import {
    useHotkeySettings,
    useVolumeWheelStep,
    useVolumeWidth,
...
export interface DlnaGroupMember {
...
export const POPOVER_BG = 'var(--mantine-color-dark-7, var(--theme-colors-surface, #1a1b1e))';
export const POPOVER_BORDER = '1px solid var(--mantine-color-dark-4, rgba(255,255,255,0.15))';
export const POPOVER_SHADOW = '0 4px 20px rgba(0,0,0,0.55)';
export const POPOVER_RADIUS = '8px';
export const POPOVER_TEXT = '#e0e0e0';
export const POPOVER_SUBTEXT = 'var(--theme-colors-subtext, #c1c2c5)';
